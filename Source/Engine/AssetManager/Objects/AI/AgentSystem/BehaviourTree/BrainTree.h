...
namespace BrainTree
{
	...
	class Node : public Reflectable<Node>
	{
	public:
		reflectable(Node);
		enum class Status
	...
	class Composite : public Reflectable<Composite>, public Node
	{
	public:
		reflectable(Composite);
		virtual ~Composite()
		{
		}
	...
	class Decorator : public Reflectable<Decorator>, public Node
	{
	public:
	...
	class Leaf : public Reflectable<Leaf>, public Node
	{
	public:
		reflectable(Leaf);
		Leaf()
	...
	class BehaviorTree : public Reflectable<BehaviorTree>, public Node
	{
	public:
		reflectable(BehaviorTree);
		BehaviorTree()
		{
	...
	class Selector : public Reflectable<Selector>, public Composite
	{
	public:
		reflectable(Selector);
	...
	class Sequence : public Reflectable<Sequence>, public Composite
	{
	public:
		reflectable(Sequence);
		void initialize() override
		{
			it = children.begin();
		}
	...
	class StatefulSelector : public Reflectable<StatefulSelector>, public Composite
	{
	public:
		reflectable(StatefulSelector);
		Status update() override
		{
			assert(hasChildren() && "Composite has no children");
	...
	class StatefulSequence : public Reflectable<StatefulSequence>, public Composite
	{
	public:
		reflectable(StatefulSequence);
		Status update() override
		{
			assert(hasChildren() && "Composite has no children");
	...
	class ParallelSequence : public Reflectable<ParallelSequence>, public Composite
	{
	public:
		reflectable(ParallelSequence);
	...
	class Succeeder : public Reflectable<Succeeder>, public Decorator
	{
	public:
		reflectable(Succeeder);
		Status update() override
		{
			child->tick();
			return Status::Success;
	...
	class Failer : public Reflectable<Failer>, public Decorator
	{
	public:
		reflectable(Failer);
		Status update() override
	...
	class Inverter : public Reflectable<Inverter>, public Decorator
	{
	public:
		reflectable(Inverter);
		Status update() override
		{
	...
	class Repeater : public Reflectable<Repeater>, public Decorator
	{
	public:
		reflectable(Repeater);
	...
	class UntilSuccess : public Reflectable<UntilSuccess>, public Decorator
	{
	public:
		reflectable(UntilSuccess);
		Status update() override
		{
			while (1)
			{
	...
	class UntilFailure : public Reflectable<UntilFailure>, public Decorator
	{
	public:
		reflectable(UntilFailure);
		Status update() override
		{
			while (1)
			{
