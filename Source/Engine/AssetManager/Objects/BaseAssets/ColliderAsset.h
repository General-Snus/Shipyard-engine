...
class ColliderAsset :public Reflectable<ColliderAsset>, public AssetBase
{
public:
	reflectable(ColliderAsset);
...
class ColliderAssetAABB : public Reflectable<ColliderAssetAABB>, public ColliderAsset
{
public:
	reflectable(ColliderAssetAABB);
...
class ColliderAssetBox :public Reflectable<ColliderAssetBox>, public ColliderAsset {
public:
	reflectable(ColliderAssetBox);
...
class ColliderAssetSphere : public Reflectable<ColliderAssetSphere>, public ColliderAsset
{
public:
	reflectable(ColliderAssetSphere);
...
class ColliderAssetConvex : public Reflectable<ColliderAssetConvex>, public ColliderAsset
{
public:
	reflectable(ColliderAssetConvex);
...
class ColliderAssetPlanar :public Reflectable<ColliderAssetPlanar>, public ColliderAsset
{
public:
	reflectable(ColliderAssetPlanar);
