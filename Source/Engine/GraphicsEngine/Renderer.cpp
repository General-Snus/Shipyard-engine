...
void Renderer::EnvironmentLightPass(std::shared_ptr<CommandList> commandList) {
...
void Renderer::ToneMapperPass(std::shared_ptr<CommandList> commandList,Texture* target) {
