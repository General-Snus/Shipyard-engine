...
static void SetupImGuiStyle(Theme theme)
{
	...
	colors[ImGuiCol_Border] = ImVec4(0.62f, 0.62f, 0.62f, 0.00f);
	...
	colors[ImGuiCol_SliderGrabActive] = ImVec4(0.73f, 0.51f, 0.30f, 1.00f);
	...
	colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.90f, 0.62f, 0.37f, 1.00f);
	colors[ImGuiCol_ResizeGripActive] = ImVec4(0.73f, 0.51f, 0.30f, 1.00f);
	colors[ImGuiCol_TabHovered] = ImVec4(0.90f, 0.62f, 0.37f, 1.00f);
	colors[ImGuiCol_Tab] = ImVec4(0.13f, 0.13f, 0.13f, 1.00f);
	colors[ImGuiCol_TabSelected] = ImVec4(0.90f, 0.62f, 0.37f, 1.00f);
	colors[ImGuiCol_TabSelectedOverline] = ImVec4(0.95f, 0.51f, 0.00f, 1.00f);
	colors[ImGuiCol_TabDimmed] = ImVec4(0.14f, 0.14f, 0.14f, 1.00f);
	colors[ImGuiCol_TabDimmedSelected] = ImVec4(0.13f, 0.13f, 0.13f, 1.00f);
	colors[ImGuiCol_TabDimmedSelectedOverline] = ImVec4(0.82f, 0.56f, 0.33f, 1.00f);
	...
	colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.90f, 0.62f, 0.37f, 1.00f);
	...
	colors[ImGuiCol_NavCursor] = ImVec4(0.15f, 0.15f, 0.15f, 1.00f);
	colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.83f, 0.41f, 0.41f, 1.00f);
...
void Editor::TopBar()
{
	...
	if (ImGui::BeginMainMenuBar())
	{
		...
		{
			ImGui::Button(std::format("Layout {}", i).c_str());
			ImGui::SameLine();
		}
