...
bool    ImGui_ImplDX12_CreateDeviceObjects() {
    ...
    // Create the root signature
    {
        ...
        param[0].Constants.Num32BitValues = 16; //16
        param[0].ShaderVisibility = D3D12_SHADER_VISIBILITY_VERTEX;

        param[1].ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE; // 1
        ...
        param[2].Constants.Num32BitValues = 64-(16+1);
        param[2].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL; // Texture viewer wants it
