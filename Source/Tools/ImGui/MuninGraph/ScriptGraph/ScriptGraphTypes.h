...
public:
	...
	virtual void RenderConstructWidget(const std::string& aContainerUUID, void* aDataPtr, const ScriptGraphType& aTypeInfo) {aContainerUUID; aDataPtr; aTypeInfo;}
	virtual std::string ToString(const void* aDataPtr, const ScriptGraphType& aTypeInfo) const { aDataPtr; aTypeInfo; return ""; }
