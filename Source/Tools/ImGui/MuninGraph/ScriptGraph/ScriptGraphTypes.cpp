...
GraphColor ScriptGraphDataTypeRegistry::GetDataTypeColor(const std::type_index aType)
{
	if(auto type = GetType(aType))
	{
		return type->Color;
...
GraphColor ScriptGraphDataTypeRegistry::GetDataTypeColorNormalized(const std::type_index aType)
{
