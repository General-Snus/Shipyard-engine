 ...
 * \tparam NodeGraphSchemaClass The class you're deriving from NodeGraphSchema, to provide type information to Munin
 * Graph. \tparam NodeGraphClass The class for the Node Graph that this Schema will govern. \tparam NodeClass The base
 * class for Nodes that will live in the Node Graph this Schema governs.
 */
template <typename NodeGraphSchemaClass, typename NodeGraphClass, typename NodeClass, typename NodeEdgeClass,
          typename NodePinClass>
class NodeGraphSchema : public GraphSchemaBase
{
  ...
  public:
    ...
    NodeGraphSchema(NodeGraphClass *aGraph) : GraphSchemaBase(typeid(NodeGraphSchemaClass)), myGraph(aGraph)
    {
    }
