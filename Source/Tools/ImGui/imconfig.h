...
// Requires lunasvg headers to be available in the include path + program to be linked with the lunasvg library (not
// provided). Only works in combination with IMGUI_ENABLE_FREETYPE. (implementation is based on Freetype's rsvg-port.c
...
#define IM_VEC2_CLASS_EXTRA                                                                                            \
	constexpr ImVec2(const std::array<float, 2> &arr)                                                                  \
	{                                                                                                                  \
		x = arr[0];                                                                                                    \
		y = arr[1];                                                                                                    \
	}
...
#define IM_VEC4_CLASS_EXTRA                                                                                            \
	constexpr ImVec4(const std::array<float, 4> &arr)                                                                  \
	{                                                                                                                  \
		x = arr[0];                                                                                                    \
		y = arr[1];                                                                                                    \
		z = arr[2];                                                                                                    \
