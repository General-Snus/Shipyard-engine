...
inline int Child(int i, bool Right) { return (2 * i + static_cast<int>(Right) + 1); }
...
template <class T>
Heap<T>::Heap(int allocate) : size(-1)
{
	arr = new T[allocate];
}
