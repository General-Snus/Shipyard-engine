...
template <class T> inline Vector2<T>::Vector2(const T &aX, const T &aY) : x(aX), y(aY)
{
}

template <class T> inline Vector2<T>::Vector2(const VectorX<T, 2> &aVector) : x(aVector[0]), y(aVector[1])
{
}
