...
class UUIDGenerator {
  public:
    UUIDGenerator() : generator(new RNG(std::random_device()())), distribution(0,ULLONG_MAX)
    {}

    UUIDGenerator(uint64_t seed) : generator(new RNG(seed)), distribution(0,ULLONG_MAX)
    {}

    UUIDGenerator(RNG &gen) : generator(gen), distribution(0,ULLONG_MAX)
    {}
