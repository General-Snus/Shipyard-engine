...
class GPU : public Singleton
{
  public:
	...
	std::shared_ptr<DirectX::DX12::GraphicsMemory> m_GraphicsMemory;
...
template <typename vertexType>
inline bool GPU::CreateVertexBuffer(const std::shared_ptr<CommandList> &commandList, VertexResource &outVxBufferView,
									const std::vector<vertexType> &aVertexList)
{
