...
template <typename T, typename U> inline static T string_cast(const U &someString)
{
    someString;
    throw NotImplemented();
}

template <> inline std::wstring string_cast<std::wstring>(const std::string &someString)
{
...
template <> inline std::string string_cast<std::string>(const std::wstring &someString)
{
    const auto sLength = static_cast<int>(someString.length());
