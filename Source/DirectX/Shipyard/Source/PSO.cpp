...
void PSO::InitRootSignature()
{
	...
	Helpers::ThrowIfFailed(m_Device->CreateRootSignature(0,signature->GetBufferPointer(),signature->GetBufferSize(),IID_PPV_ARGS(&m_RootSignature.m_RootSignature)));
...
void TonemapPSO::InitRootSignature()
{
	...
	CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC rootSignatureDescription;
	rootSignatureDescription.Init_1_1(0,nullptr,1,&linearRepeatSampler,rootSignatureFlags);
